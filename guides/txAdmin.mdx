...
Keep in mind first time loading of the server takes more as it has to configure the resources, so let the server do its job and read/load the resources properly....
